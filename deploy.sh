...
scp conference.tar.gz docker-compose.yml Caddyfile root@95.217.238.72:/root/conference/

# Deploy on server
echo "🔄 Deploying on server..."
ssh root@95.217.238.72 << 'EOF'
cd /root/conference
...
echo "🌐 Server: wss://95.217.238.72.nip.io/ws"
